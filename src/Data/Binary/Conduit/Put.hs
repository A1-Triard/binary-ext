...
-- | Write a Word64 in native host order On a 32 bit machine we write two host order Word32s,
...
-- | Write an Int64 in native host order On a 32 bit machine we write two host order Int32s,
